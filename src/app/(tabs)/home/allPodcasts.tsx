...
//   >({
//     queryKey: ["podcast_filter_pairs", lang],
//     queryFn: async () => {
...
//       number
//     >({
//       queryKey: ["all_podcasts_filtered", lang, selectedTopic, selectedAuthor],
...
//                       ]}
//                     >
//                       {parseTopics((item as any).podcast_topic).join(", ")}
//                     </Text>
//                   </View>
//                 ) : null}
//               </View>
